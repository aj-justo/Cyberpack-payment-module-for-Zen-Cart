...
*/
  ...
  define('MODULE_PAYMENT_CYBERPACK_TEXT_TITLE', 'Credit cards<br/><img src="/images/credit-cards.jpg" alt="" />');  
	
  define('MODULE_PAYMENT_CYBERPACK_TEXT_DESCRIPTION','Credit cards via Cyberpack/Seperma');
?>